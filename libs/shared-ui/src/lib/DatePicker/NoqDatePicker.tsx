                ...
                popoverTrigger={
                    ...
                    >
                        ...
                        >
                            {/* Year Input */}
                            <input
                                className="w-[35%] h-full focus:outline-none font-inter text-[13px] text-[#303030] focus:bg-gray-100 rounded-md caret-transparent text-center cursor-pointer"
                                type='text'
                                onFocus={() => {
                                    setIsOpen(true);
                            ...
                            {/* Month Input */}
                            <input
                                className="w-[22%] h-full focus:outline-none font-inter text-[13px] text-[#303030] focus:bg-gray-100 rounded-md caret-transparent text-center cursor-pointer"
                                type='text'
                                onFocus={() => {
                                    setIsOpen(true);
                                    setShouldClearOnInput(prev => ({
