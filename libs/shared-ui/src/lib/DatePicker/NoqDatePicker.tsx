...
export function NoqDatePicker({
    ...
    useEffect(() => {
        console.log("valueState ===> ", valueState, setValueState)
        ...
        <FrankPopoverGeneral
            popoverTrigger={
                <div
                    ...
                    className="border-1 border-[#B5B5B5] bg-[#FFF] rounded-md pl-3 pr-[6px] py-[6px] flex items-center justify-between"
                >
                    {/* date input */}
                    <div
                    ...
                    >
                        <input
                            className="w-[40%] h-full focus:outline-none font-inter text-[13px] text-[#303030] focus:bg-gray-100 rounded-md caret-transparent text-center"
                            type='text'
                            ...
                            onChange={(e) => {
                                ...
                                const lastInputChar = inputEvent.data; // 获取最新输入的字符
                                if (value.length < 5) {
                                    setInputValue(prev => ({
                                        ...prev,
                                        year: numericValue
